  ...
  return (
    <main>
            ...
            <div class="typewriter flex flex-col ml-8 mt-8">
              ...
              <div class="flex flex-row mt-8 space-x-4">
                <Button as={A} href="/resume" size="lg">
                  <img src="/icons/markdown.svg" class="size-6 mr-2" />
                  Resume.md
                </Button>
                <Button as={A} href="/#about" variant="outline" size="lg">
                  <img src="/icons/corner-left-down.svg" class="size-6 mr-2 invert" />
                  About Me</Button>
      ...
      <div class="h-screen pt-48 px-40">
        ...
        <div class="grid p-4 grid-cols-4 grid-rows-4 gap-4">
          <div class="border ">Certified Drone Pilot</div>
          <div class="border">Risk At Rest: How is the US Government protecting ciitizens data?</div>
        </div>
      </div>
    </main>
  );
